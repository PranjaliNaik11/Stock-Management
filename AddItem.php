						...
						<span class="fa-stack fa-4x">
							...
							<form action="AddItem.php" method="post">
                                <div class="form-group">
                                    <h4>Please enter the grocery item:</h4>
									<?php
                                    echo "<input type='text' name='Name' class='form-control' placeholder='Grocery Name' id='gname' required data-validation-required-message='Please enter the Grocery Item.'>"
                                    ?>

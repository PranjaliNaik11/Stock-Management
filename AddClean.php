                ...
                <div class="col-lg-12">
						...
						<span class="fa-stack fa-4x">
							...
							<span class="fa-stack fa-4x">
							 ...
							 <form action="AddBev.php" method="post">
                                <div class="form-group">
                                    <h4>Please enter the cleaning supply item:</h4>
									<div class="form-group">
                                    <?php
										echo "<select class='form-control' id='sel1' name='Name'>
											<option>Vim Liquid Soap</option>
                                            <option>Ariel Detergent</option>
                                            <option>Fem Handwash</option>
                                            <option>CleanZit</option>
                                            <option>Ujala</option>
                                            <option>Sunlight Soap</option>
										</select>"
                                        ?>
									</div>
                       				<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <h4>Please enter the quantity:</h4>
                                        <?php
                                        echo "<input type='numeric' name='qty' class='form-control' placeholder='Number of Items' id='number' required data-validation-required-message='Please enter the number of items.'>"
                                        ?>
                                        <p class="help-block text-danger"></p>
                                    </div>
                                     <div class="form-group">
                                        <h4>Please enter the quantity to subtract daily:</h4>
                                        <?php
                                        echo "<input type='numeric' name='qty_sub' class='form-control' placeholder='Number of Items' id='number' required data-validation-required-message='Please enter the number of items.'>"
                                        ?>
                                        <p class="help-block text-danger"></p>
                                    </div>
                            </div>

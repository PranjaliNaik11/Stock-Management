							...
							<span class="fa-stack fa-4x">
							 ...
							 <form action="AddBev.php" method="post">
                                <div class="form-group">
                                    <h4>Please enter the grain grocery item:</h4>
									<div class="form-group">
                                    <?php
                                    ...
                                    <div class="form-group">
                                        <h4>Please enter the quantity in Kilograms:</h4>
                                        <?php
                                     ...
                                     <div class="form-group">
                                        <h4>Please enter the quantity to subtract daily in Grams/Kilograms:</h4>
                                        <?php

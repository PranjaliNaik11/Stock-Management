    ...
    <script>
        $(document).ready(function (){
            $("#veg1").change(function() {
                ...
                if ($(this).val() == "Carrot" || $(this).val() == "Onion" || $(this).val() == "Tomato" || $(this).val() == "Potato") {
                    $("#carrot").show();
                }else{
                    $("#carrot").hide();
                }
						...
						<span class="fa-stack fa-4x">
							...
							<span class="fa-stack fa-4x">
                                ...
                                <form action="AddVeg.php" method="post">
                                    <h4>Please enter the Vegetable grocery item:</h4>
									<div class="form-group">
                                    <label for="veg1"></label>
                                    <?php
										echo "<select class='form-control' id='veg1' name='Name'>
                       				...
                       				<div class="form-group">
                                        ...
                                        <?php
                                        echo "<input type='number' name='price' class='form-control' placeholder='Grocery Price' id='gprice' required data-validation-required-message='Please enter the Grocery Item.'>"
                                        ?>
                                    ...
                                    <div id="carrot" style="display:none;">
                                        <div class="form-group">
                                    ...
                                    <div id="spinach" style="display:none;">
                                        <div class="form-group">
                                            <h4>Please enter the number of bundles:</h4>
                                            <?php
                                            echo "<input type='number' name='qty' class='form-control' placeholder='Number of Items' id='number' required data-validation-required-message='Please enter the number of items.'>"
                                            ?>
                                            <p class="help-block text-danger"></p>
                                        ...
                                        <div class="form-group">
                                            <h4>Please enter the number of bundles to subtract daily:</h4>
                                            <?php
                                            echo "<input type='number' name='qty_sub' class='form-control' placeholder='Number of Items' id='number' required data-validation-required-message='Please enter the number of items.'>"
                                            ?>
                                            <p class="help-block text-danger"></p>
                                    ...
                                    <div id="cabbage" style="display:none;">
                                        <div class="form-group">
                                            <h4>Please enter the number of cabbage:</h4>
                                            <?php
                                            echo "<input type='number' name='qty' class='form-control' placeholder='Number of Items' id='number' required data-validation-required-message='Please enter the number of items.'>"
                                            ?>
                                            <p class="help-block text-danger"></p>
                                        ...
                                        <div class="form-group">
                                            <h4>Please enter the number of cabbage to subtract daily:</h4>
                                            <?php
                                            echo "<input type='number' name='qty_sub' class='form-control' placeholder='Number of Items' id='number' required data-validation-required-message='Please enter the number of items.'>"
                                            ?>
                                            <p class="help-block text-danger"></p>
